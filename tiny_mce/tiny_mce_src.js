 ...
 */
 ...
 // SilverStripe modification: Use &#160 instead of &nbsp
 NBSP = '&#160;'
 
 // SilverStripe modification: All nodename comparisons are case insensitive
...
TinyMCE.prototype.defParam = function(key, def_val, t) {
...
/**
 * Set-up function called by external scripts to set up TinyMCE
 */
TinyMCE.prototype.init = function(settings) {
	...
	// SilverStripe modification: use base tag for base path if it exists
	// Get document base path
	var base;
	if(base = document.getElementsByTagName('base')[0]) {
		this.documentBasePath = base.href;
	...
	this.defParam("entities", "160,nbsp,161,iexcl,162,cent,163,pound,164,curren,165,yen,166,brvbar,167,sect,168,uml,169,copy,170,ordf,171,laquo,172,not,173,shy,174,reg,175,macr,176,deg,177,plusmn,178,sup2,179,sup3,180,acute,181,micro,182,para,183,middot,184,cedil,185,sup1,186,ordm,187,raquo,188,frac14,189,frac12,190,frac34,191,iquest,192,Agrave,193,Aacute,194,Acirc,195,Atilde,196,Auml,197,Aring,198,AElig,199,Ccedil,200,Egrave,201,Eacute,202,Ecirc,203,Euml,204,Igrave,205,Iacute,206,Icirc,207,Iuml,208,ETH,209,Ntilde,210,Ograve,211,Oacute,212,Ocirc,213,Otilde,214,Ouml,215,times,216,Oslash,217,Ugrave,218,Uacute,219,Ucirc,220,Uuml,221,Yacute,222,THORN,223,szlig,224,agrave,225,aacute,226,acirc,227,atilde,228,auml,229,aring,230,aelig,231,ccedil,232,egrave,233,eacute,234,ecirc,235,euml,236,igrave,237,iacute,238,icirc,239,iuml,240,eth,241,ntilde,242,ograve,243,oacute,244,ocirc,245,otilde,246,ouml,247,divide,248,oslash,249,ugrave,250,uacute,251,ucirc,252,uuml,253,yacute,254,thorn,255,yuml,402,fnof,913,Alpha,914,Beta,915,Gamma,916,Delta,917,Epsilon,918,Zeta,919,Eta,920,Theta,921,Iota,922,Kappa,923,Lambda,924,Mu,925,Nu,926,Xi,927,Omicron,928,Pi,929,Rho,931,Sigma,932,Tau,933,Upsilon,934,Phi,935,Chi,936,Psi,937,Omega,945,alpha,946,beta,947,gamma,948,delta,949,epsilon,950,zeta,951,eta,952,theta,953,iota,954,kappa,955,lambda,956,mu,957,nu,958,xi,959,omicron,960,pi,961,rho,962,sigmaf,963,sigma,964,tau,965,upsilon,966,phi,967,chi,968,psi,969,omega,977,thetasym,978,upsih,982,piv,8226,bull,8230,hellip,8242,prime,8243,Prime,8254,oline,8260,frasl,8472,weierp,8465,image,8476,real,8482,trade,8501,alefsym,8592,larr,8593,uarr,8594,rarr,8595,darr,8596,harr,8629,crarr,8656,lArr,8657,uArr,8658,rArr,8659,dArr,8660,hArr,8704,forall,8706,part,8707,exist,8709,empty,8711,nabla,8712,isin,8713,notin,8715,ni,8719,prod,8721,sum,8722,minus,8727,lowast,8730,radic,8733,prop,8734,infin,8736,ang,8743,and,8744,or,8745,cap,8746,cup,8747,int,8756,there4,8764,sim,8773,cong,8776,asymp,8800,ne,8801,equiv,8804,le,8805,ge,8834,sub,8835,sup,8836,nsub,8838,sube,8839,supe,8853,oplus,8855,otimes,8869,perp,8901,sdot,8968,lceil,8969,rceil,8970,lfloor,8971,rfloor,9001,lang,9002,rang,9674,loz,9824,spades,9827,clubs,9829,hearts,9830,diams,34,quot,38,amp,60,lt,62,gt,338,OElig,339,oelig,352,Scaron,353,scaron,376,Yuml,710,circ,732,tilde,8194,ensp,8195,emsp,8201,thinsp,8204,zwnj,8205,zwj,8206,lrm,8207,rlm,8211,ndash,8212,mdash,8216,lsquo,8217,rsquo,8218,sbquo,8220,ldquo,8221,rdquo,8222,bdquo,8224,dagger,8225,Dagger,8240,permil,8249,lsaquo,8250,rsaquo,8364,euro", true);
	...
	this.defParam("browsers", "msie,safari,gecko,opera", true);
	this.defParam("dialog_type", "window");
	this.defParam("accessibility_warnings", true);
	this.defParam("accessibility_focus", true);
	...
	this.defParam("font_size_style_values", 'xx-small,x-small,small,medium,large,x-large,xx-large', true);
	this.defParam("event_elements", 'a,img'), true;
...
TinyMCE.prototype.loadScript = function(url) {
	...
	// SilverStripe modification: Use dom if document.write fails
	try {
...
TinyMCE.prototype.importCSS = function(doc, css_file) {
	...
	// SilverStripe modification: Always do this conditional
	if (true || typeof(doc.createStyleSheet) == "undefined") {
...
TinyMCE.prototype.updateContent = function(form_element_name) {
	...
	for (var n in tinyMCE.instances) {
		...
		if (inst.formElement == formElement) {
			var doc = inst.getDoc();
			// SilverStripe modification: pass inst to _setHTML
			tinyMCE._setHTML(doc, inst.formElement.value, inst);
...
TinyMCE.prototype.addMCEControl = function(replace_element, form_element_name, target_document) {
	...
	var inst = new TinyMCEControl(settings);
...
TinyMCE.prototype.triggerSave = function(skip_cleanup, skip_callback) {
	...
	for (var n in tinyMCE.instances) {
		...
		// SilverStripe modificaiton: commented this out
		// tinyMCE._setHTML(inst.getDoc(), inst.getBody().innerHTML, inst);
		...
		// SilverStripe modification: wrapped customCleanup in this if statement
		if(inst.contentWindow && inst.contentWindow.document && inst.contentWindow.document.body) {
		...
		// SilverStripe modification: Added inst stuff here
		if (inst.formElement) {
			inst.formElement.value = htm;
			// SilverStripe CMS uses this :)
			inst.formElement.inst = inst;
			inst.formElement.isChanged = function () { 
				return this.inst.isDirty();
			}
			inst.formElement.resetChanged = function() {
				this.inst.startContent = tinyMCE.trim(this.inst.getBody().innerHTML);
			}
		}
	}
};
...
TinyMCE.prototype.execInstanceCommand = function(editor_id, command, user_interface, value, focus) {
	// SilverStripe modification: Added this if statement
	if(typeof editor_id == 'object') var inst = editor_id;
	else var inst = tinyMCE.getInstanceById(editor_id);
...
TinyMCE.prototype.addEventHandlers = function(editor_id) {
	if (tinyMCE.isMSIE) {
		// SilverStripe modification: Added try-catch
		try {
			var doc = document.frames[editor_id].document;
		} catch(er) { return; } 
					// this error occurs when you've gone to another page while TinyMCE was
					// waiting around to call addEventHandlers.
...
TinyMCE.prototype._createIFrame = function(replace_element, inst) {
	// SilverStripe modification: Used to get settings
	if(inst == null) inst = tinyMCE;
	
	var iframe = document.createElement("iframe");
	var id = replace_element.getAttribute("id");
	// tinyMCE.debug("Creating an iframe for " + id);
	
	var aw, ah;

	// SilverStripe modification: use inst settings
	aw = "" + inst.settings['area_width'];
	ah = "" + inst.settings['area_height'];
	
	// SilverStripe modification: Added these extra values because area_height is getting inexplicably overwritten
	inst.minHeight = parseInt(ah);
	inst.minWidth = parseInt(ah);
...
TinyMCE.prototype.setupContent = function(editor_id) {
	...
	/* SilverStripe modification: This has been causing no end of problems, commented out
	...
	if (!tinyMCE.isMSIE && tinyMCE.getParam("setupcontent_reload", false) && doc.title != "blank_page") {
		...
		window.setTimeout("tinyMCE.setupContent('" + editor_id + "');", 100);
		return;
	}
	*/

	// SilverStripe modification: Only if IE
	if (tinyMCE.isMSIE && !head) {
...
//	content = content.replace(new RegExp('<a(.*?)/>', 'gi'), '<a$1></a>');
	...
	if (!tinyMCE.isMSIE) {
		...
		if (tinyMCE.settings['cleanup_on_startup']) {
			// SilverStripe modification: pass inst to _setHTML
			tinyMCE._setHTML(inst.getDoc(), content, inst);
	...
	// Original content for checking if there's a change.
...
TinyMCE.prototype.cleanupHTMLCode = function(s) {
	s = s.replace(/<p \/>/gi, '<p>' + NBSP + '</p>');
	s = s.replace(/<p>\s*<\/p>/gi, '<p>' + NBSP + '</p>');
...
TinyMCE.prototype.accessibleEventHandler = function(e) {
	...
	// Piggyback onchange
	if (elm.nodeName.toUpperCase() == "SELECT" && !elm.oldonchange) {
	...
	switch (e.type) {
		case "blur":
			if (tinyMCE.selectedInstance) {
				...
				// SilverStripe modification: call blur
				tinyMCE.selectedInstance.blur();
			}
		...
		case "submit":
			...
			tinyMCE.triggerSave();
			// SilverStripe modification: commented this out
		...
		case "focus":
			...
			for (var instanceName in tinyMCE.instances) {
				...
				if (inst.getBody() == targetBody) {
					...
					// SilverStripe modification: Remove the wfocused classs
					tinyMCE.selectedInstance.blur(true);
					inst.focus();
...
/**
 * Actually set up the TinyMCE editors.
 * This script is hooked up to window.onload by init()
 */
...
TinyMCE.prototype._cleanupElementName = function(element_name, element) {
	...
	if (tinyMCE.cleanup_verify_html) {
		...
		for (var i=0; i<tinyMCE.cleanup_validElements.length && !elementAttribs; i++) {
			for (var x=0, n=tinyMCE.cleanup_validElements[i][0].length; x<n; x++) {
				...
				// SilverStripe modification: also check for #
				if (elmMatch.charAt(0) == '+' || elmMatch.charAt(0) == '-' ||  elmMatch.charAt(0) == '#')
	...
	// SilverStripe modification: Also check for #
	if (element_name.charAt(0) == '+' || element_name.charAt(0) == '-' || elmMatch.charAt(0) == '#') {
		chr = element_name.charAt(0);
	...
	if (tinyMCE.cleanup_inline_styles) {
		...
		if (val != '') {
			...
			switch (attrib) {
				...
				case "align":
					if (elm.nodeName.toUpperCase() == "IMG") {
						if (tinyMCE.isMSIE)
...
TinyMCE.prototype._cleanupAttribute = function(valid_attributes, element_name, attribute_node, element_node) {
	...
	switch (attribName) {
		...
		case "class":
			...
			if (element_name == "table" || element_name == "td" || element_name == "th") {
				...
				if (tinyMCE.cleanup_visual_table_class != "") {
					...
					element_node.setAttribute("className", attribValue);
					element_node.setAttribute("class", attribValue);
				}
			}
		...
		case "longdesc":
			...
			// SilverStripe modification: Force relative URLs
			if(tinyMCE.getParam('relative_urls') && (attribValue.substr(0,1) == '/' || attribValue.substr(0,4) == 'http'))
				attribValue = tinyMCE.convertAbsoluteURLToRelativeURL(tinyMCE.settings['base_href'], attribValue);
...
TinyMCE.prototype.cleanupNode = function(node) {
	...
	switch (node.nodeType) {
		case 1: // Element
			...
			// SilverStripe modification: check for #
			if (elementName != null && elementName.charAt(0) == '#') {
				elementName = elementName.substring(1);
			}
			...
			if (tinyMCE.cleanup_on_save) {
				if (node.nodeName.toUpperCase() == "A" && node.className == "mceItemAnchor") {
					if (node.hasChildNodes()) {
						for (var i=0; i<node.childNodes.length; i++)
							output += this.cleanupNode(node.childNodes[i]);
					}
			...
			if (re.test(node.nodeName)) {
				...
				if ((node.nodeName.toUpperCase() != "TABLE" || tinyMCE.cleanup_inline_styles) && (width = tinyMCE.getAttrib(node, "width")) != '') {
					node.style.width = width.indexOf('%') != -1 ? width : width.replace(/[^0-9]/gi, '') + "px";
					node.removeAttribute("width");
				}

				// Is table and not inline
				if ((node.nodeName.toUpperCase() == "TABLE" && !tinyMCE.cleanup_inline_styles) && node.style.width != '') {
			...
			if (tinyMCE.cleanup_inline_styles) {
				...
				if (node.nodeName.toUpperCase() == "FONT")
			...
			if (elementValidAttribs) {
				for (var a=1; a<elementValidAttribs.length; a++) {
					...
					if (attribDefaultValue != null || attribForceValue != null) {
						...
						if (attribName == "class" && elementName == "table" || elementName == "td" || elementName == "th")
							attribValue = tinyMCE.getVisualAidClass(attribValue, tinyMCE.cleanup_on_save);
				...
				for (var i=0; i<node.attributes.length; i++) {
					if (node.attributes[i].specified) {
						...
						if (attrib && attrib.value != "") {
							...
							// SilverStripe modification: Needed for linebreaks in IE 
							attribValue = attribValue.replace(/\r/g,'%0D').replace(/\n/g,'%0A');							
							elementAttribs += " " + attrib.name + "=" + '"' + this.convertStringToXML(attribValue) + '"';
						}
					}
				}
			}
			...
			if ((elementName == "p" || elementName == "td") && (node.innerHTML == "" || node.innerHTML == "&nbsp;" || node.innerHTML == "&#160;"))
		...
		case 3: // Text
			...
			if (node.parentNode.nodeName.toUpperCase() == "SCRIPT" || node.parentNode.nodeName.toUpperCase() == "NOSCRIPT" || node.parentNode.nodeName.toUpperCase() == "STYLE")
...
TinyMCE.prototype.convertStringToXML = function(html_data) {
	...
	for (var i=0; i<html_data.length; i++) {
		...
		if (tinyMCE.settings['entity_encoding'] == "raw") {
			if (chr == 60 || chr == 62 || chr == 38 || chr == 39 || chr == 34) {
...
/**
 * Set up the HTML-cleaner system
 */
...
/**
 * Clean up the HTML of the given instance.  Returns the clean HTML
 */
TinyMCE.prototype._cleanupHTML = function(inst, doc, config, element, visual, on_save) {
	...
	html = tinyMCE.regexpReplace(html, '<p>' + NBSP + '</p><hr /><p>' + NBSP + '</p>', '<hr />');
	html = tinyMCE.regexpReplace(html, '<td>\\s*<br />\\s*</td>', '<td>' + NBSP + '</td>');
	html = tinyMCE.regexpReplace(html, '<p>\\s*<br />\\s*</p>', '<p>' + NBSP + '</p>');
	html = tinyMCE.regexpReplace(html, '<p>\\s*' + NBSP + '\\s*<br />\\s*' + NBSP + '\\s*</p>', '<p>' + NBSP + '</p>');
	html = tinyMCE.regexpReplace(html, '<p>\\s*' + NBSP + '\\s*<br />\\s*</p>', '<p>' + NBSP + '</p>');
	html = tinyMCE.regexpReplace(html, '<p>\\s*<br />\\s*' + NBSP + '\\s*</p>', '<p>' + NBSP + '</p>');
...
// SilverStripe modification: Added getLinkElement
TinyMCE.prototype.getLinkElement = function() {
...
TinyMCE.prototype.insertLink = function(href, target, title, onclick, style_class) {
	...
	if (this.selectedInstance && this.selectedElement && this.selectedElement.nodeName.toLowerCase() == "img") {
        ...
        // SilverStripe modification: Added style_class check
   		if(style_class) tinyMCE.setAttrib(linkElement, 'class', style_class);
		else Element.removeClassName(linkElement, 'broken');
	...
	if (!this.linkElement && this.selectedInstance) {
		...
		for (var i=0; i<elementArray.length; i++) {
            ...
            // SilverStripe modification: Added style_class check
			if(style_class) tinyMCE.setAttrib(elementArray[i], 'class', style_class);
			else Element.removeClassName(elementArray[i], 'broken');
		}
	...
	if (this.linkElement) {
        ...
        // SilverStripe modification: Added style_class check
		if(style_class) tinyMCE.setAttrib(this.linkElement, 'class', style_class);
			else Element.removeClassName(this.linkElement, 'broken');
	}

	tinyMCE.execCommand('mceEndUndoLevel');
};

TinyMCE.prototype.insertImage = function(src, alt, border, hspace, vspace, width, height, align, title, onmouseover, onmouseout, className) {
	tinyMCE.execCommand('mceBeginUndoLevel');
	...
	if (!this.imgElement && tinyMCE.isSafari) {
		...
		html += ' height="' + height + '" align="' + align + '" title="' + title + '" onmouseover="' + onmouseover + '" onmouseout="' + onmouseout + '" class="' + className + '" />';
	...
	if (this.imgElement) {
		...
		tinyMCE.setAttrib(this.imgElement, 'class', className);
	...
	tinyMCE.execCommand('mceEndUndoLevel');
	// SilverStripe modification: return imgElement
	return this.imgElement;
};

/**
 * Return a single element where the attribute has the given value.
 */
...
/**
 * Return all elements where the given attribute has the given value
 */
...
TinyMCE.prototype.convertAbsoluteURLToRelativeURL = function(base_url, url_to_relative) {
	...
	//	SilverStripe modification: Check targetURL.host == baseURL.host
...
TinyMCE.prototype.triggerNodeChange = function(focus, setup_content) {
	// SilverStripe modification: Use selectedInstance settings
	if (tinyMCE.selectedInstance.settings['handleNodeChangeCallback']) {
		if (tinyMCE.selectedInstance) {
			var inst = tinyMCE.selectedInstance;
			...
			inst.switchSettings();
			// SilverStripe modificaiton: Use custom auto resize method
			inst.autoResizeIfNeeded();

			if (tinyMCE.selectedElement)
				anySelection = (tinyMCE.selectedElement.nodeName.toLowerCase() == "img") || (selectedText && selectedText.length > 0);

			// SilverStripe modification: Use selectInstance settings
			if (tinyMCE.selectedInstance.settings['custom_undo_redo']) {
	...
	// SilverStripe modification:
	// UGLY: This should be done with an observer	
	$('Form_EditorToolbarLinkForm').respondToNodeChange();
...
TinyMCE.prototype.setAttrib = function(element, name, value, fix_value) {
	...
	// SilverStripe modification: Use else ifs instead of lots of ifs, check for alt
	if (name == "style") {
		...
		if(name == 'alt') element.setAttribute(name, '');
...
// SilverStripe modification: add inst argument
TinyMCE.prototype._setHTML = function(doc, html_content, inst) {
	...
	// SilverStripe modification: call auto resize function
	inst.autoResizeIfNeeded();
};
...
TinyMCE.prototype.debug = function() {
	...
	if (!elm) {
		...
		// SilverStripe modification: Add debug div styles	
		debugDiv.style.width = "200px";
...
TinyMCEControl.prototype.getDoc = function() {
	// SilverStripe modification: IE check
	if(navigator.appName == 'Microsoft Internet Explorer') return this.contentWindow.document;
	else return this.contentDocument;
};
...
//	debug(e.target, sel.anchorNode.nodeName, sel.focusNode.nodeName, rng.startContainer, rng.endContainer, rng.commonAncestorContainer, sel.anchorOffset, sel.focusOffset, rng.toString());
	...
	startNode = startNode.nodeName.toUpperCase() == "BODY" ? startNode.firstChild : startNode;
	endNode = endNode.nodeName.toUpperCase() == "BODY" ? endNode.firstChild : endNode;
	...
	if ((startBlock != null && startBlock.nodeName.toUpperCase() == "TABLE") || (endBlock != null && endBlock.nodeName.toUpperCase() == "TABLE"))
	...
	if (startChop.nodeName.toUpperCase() == "TD")
		startChop = startChop.firstChild;

	if (endChop.nodeName.toUpperCase() == "TD")
	...
	if (startBlock == null) {
		...
		if (startChop != rootElm && endChop != rootElm) {
			...
			if (endChop.parentNode.nodeName.toUpperCase() == blockName)
				endChop = endChop.parentNode;

			// If not after image
			//if (rng.startContainer.nodeName.toUpperCase() != "BODY" && rng.endContainer.nodeName.toUpperCase() != "BODY")
				rng.setEndAfter(endChop);

			if (endChop.nodeName != "#text" && endChop.nodeName.toUpperCase() != "BODY")
				rngBefore.setEndAfter(endChop);

			var contents = rng.cloneContents();
			if (contents.firstChild && (contents.firstChild.nodeName.toUpperCase() == blockName || contents.firstChild.nodeName.toUpperCase() == "BODY"))
			...
			if (isEmpty(paraBefore))
				paraBefore.innerHTML = NBSP;

			// Check if it's a empty paragraph
			if (isEmpty(paraAfter))
				paraAfter.innerHTML = NBSP;
			...
			body.innerHTML = "<" + blockName + ">" + NBSP + "</" + blockName + "><" + blockName + ">" + NBSP + "</" + blockName + ">";
	...
	if (startChop.nodeName.toUpperCase() == blockName)
		rngBefore.setStart(startChop, 0);
	else
		rngBefore.setStartBefore(startChop);
	...
	if (contents.firstChild && contents.firstChild.nodeName.toUpperCase() == blockName) {
...
TinyMCEControl.prototype._handleBackSpace = function(evt_type) {
	...
	if (para != null && para.nodeName.toLowerCase() == 'p' && evt_type == "keypress") {
		...
		if (htm == "" || htm == NBSP || block.nodeName.toLowerCase() == "li") {
...
TinyMCEControl.prototype.isDirty = function() {
	// SilverStripe modification: Rewrote isDirty
	
	// Is content modified and not in a submit procedure
	/*
	if(this.startContent != tinyMCE.trim(this.getBody().innerHTML)) {
		var j;
		for(j=0;j<this.startContent.length;j+=1500) {
			alert(this.startContent.substr(j,1500) + '\n\n' + tinyMCE.trim(this.getBody().innerHTML).substr(j,1500));
		}
	}
	*/

	return this.startContent.replace(/<br[^>]*>/g,'') != tinyMCE.trim(this.getBody().innerHTML).replace(/<br[^>]*>/g,'') /*&& !tinyMCE.isNotDirty*/;
};
...
TinyMCEControl.prototype.execCommand = function(command, user_interface, value) {
	...
	// Fix align on images
	if (focusElm && focusElm.nodeName.toUpperCase() == "IMG") {
		...
		switch (command) {
			case "JustifyLeft":
				...
				if (div && div.nodeName.toUpperCase() == "DIV" && div.childNodes.length == 1 && div.parentNode)
			...
			case "JustifyCenter":
				...
				if (div && div.style.textAlign == "center") {
					// Remove div
					if (div.nodeName.toUpperCase() == "DIV" && div.childNodes.length == 1 && div.parentNode)
						div.parentNode.replaceChild(img, div);
				} else {
					// Add div
	...
	switch (command) {
		...
		case "InsertOrderedList":
			...
			if (tinyMCE.isSafari)
				this.execCommand("mceInsertContent", false, "<" + tag + "><li>" + NBSP + "</li><" + tag + ">");
			else
		...
		case "mceSetContent":
			...
			// SilverStripe modification: pass inst to _setHTML
			tinyMCE._setHTML(doc, value, this);
		...
		case "mceImage":
			...
			if (img) {
				...
				className = tinyMCE.getAttrib(img, 'class');
			...
			if (this.settings['insertimage_callback']) {
				var returnVal = eval(this.settings['insertimage_callback'] + "(src, alt, border, hspace, vspace, width, height, align, title, onmouseover, onmouseout, action, className);");
				if (returnVal && returnVal['src'])
					tinyMCE.insertImage(returnVal['src'], returnVal['alt'], returnVal['border'], returnVal['hspace'], returnVal['vspace'], returnVal['width'], returnVal['height'], returnVal['align'], returnVal['title'], returnVal['onmouseover'], returnVal['onmouseout'], returnVal['className']);
			} else
				tinyMCE.openWindow(this.insertImageTemplate, {src : src, alt : alt, border : border, hspace : hspace, vspace : vspace, width : width, height : height, align : align, title : title, onmouseover : onmouseover, onmouseout : onmouseout, action : action, inline : "yes", className : className});
		break;

		case "mceCleanup":
			// SilverStripe modification: pass inst to _setHTML
			tinyMCE._setHTML(this.contentDocument, this.getBody().innerHTML, this);
		...
		default:
			// SilverStripe modification: try-catch
			try {
				this.getDoc().execCommand(command, user_interface, value);
			} catch (er) {
				alert("Couldn't call command: " + command + ", " + value);
			}
...
TinyMCEControl.prototype.onAdd = function(replace_element, form_element_name, target_document) {
	...
	if (this.settings['width'] == 0)
		this.settings['width'] = 600; // SilverStripe modification: 600 instead of 320
	...
	if (replace_element.nodeName.toUpperCase() == "TEXTAREA" || replace_element.nodeName.toUpperCase() == "INPUT")
	...
	if (!tinyMCE.isMSIE) {
		if (tElm && tElm.nodeName.toLowerCase() == "span") {
			// SilverStripe modification: pass inst to createIFrame
			tElm = tinyMCE._createIFrame(tElm, this);
			dynamicIFrame = true;
		}
	...
	// SilverStripe modification: always do this conditional
	if (dynamicIFrame || true) {
		// SilverStripe modification: add extra classes
		var extraClass = form_element_name;
		var html = tinyMCE.getParam('doctype') + '<html><head xmlns="http://www.w3.org/1999/xhtml"><base href="' + tinyMCE.settings['base_href'] + '" /><title>blank_page</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body class="mceContentBody typography ' + extraClass + '"></body></html>';
		...
		// SilverStripe modification: Try to set designMode on here		
		try {
			doc.designMode = "on";
		} catch (e) {
...
// SilverStripe modification: Added autoResizeIfNeeded function
TinyMCEControl.prototype.autoResizeIfNeeded = function() {
	if (this.settings["auto_resize"]) {
		var doc = this.getDoc();
		
		// this.iframeElement.style.width = doc.body.scrollWidth + "px";
		
		var h = tinyMCE.isMSIE ? doc.body.scrollHeight : doc.body.offsetHeight;
		
		h = (h < this.minHeight) ? this.minHeight : h;
		
		this.iframeElement.style.height = h + "px";
		
		if(h < doc.body.scrollHeight) {
...
// SilverStripe modification: Added getToolbarElement function
TinyMCEControl.prototype.getToolbarElement = function() {
	if(typeof this.toolbarElement == 'function') return this.toolbarElement();
	else return this.toolbarElement; 
}

// SilverStripe modification: Added focus function
TinyMCEControl.prototype.focus = function() {
	this.focused = true;
	var te = this.getToolbarElement();
	if(te) {
		if(te.setFocusTo) te.setFocusTo(this);
		Element.addClassName(te, 'focused');
	}
}

// SilverStripe modification: Added blur function
TinyMCEControl.prototype.blur = function(immediate) {
	var te = this.getToolbarElement();
	if(te && te.removeFocus) te.removeFocus();
	this.focused = false;
	/*
	if(immediate) {
		var te = this.getToolbarElement();
		if(te) Element.removeFocus(te, 'focused');
		
	} else {
		setTimeout(this.blurUnlessFocused.bind(this), 100);
	}
	*/
}

// SilverStripe modification: Added blurUnlessFocused function
TinyMCEControl.prototype.blurUnlessFocused = function() {
	if(!this.focused) this.blur(true);
}
